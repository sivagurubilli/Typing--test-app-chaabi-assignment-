 ...
 const handleclick=()=>{
  ...
  return (
    ...
    <div >
        ...
        >
              <p className='typingheading'>Typying speed testing app</p>
          <img className='imgtyping' src ="https://play-lh.googleusercontent.com/fk8F1qf9sx3nnzGH4VGNqe4Kuc4RGHaOqJgM7CcVvXJ27LHgoZN_4n0Dw_Sa3hiTYITU"/>
